        ...
        return (
           <div className="all-forms-style">
               ...
               <div className="steps-startup">
                   <ul>
                       <li className='actbread'><div className="number">1</div> <span>Identitas Calon Penerbit</span></li>
               ...
               <div className="box-form-data">
                   {/* ///////////////////FORMS//////////////////// */}
                    <p className="title">Identitas Calon Penerbit</p>
...
export default StartUpDataDiri;